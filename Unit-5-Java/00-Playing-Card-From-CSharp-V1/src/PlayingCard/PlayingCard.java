//namespace Playing_Card_Poker_Game; //C# groups things in namspaces
package PlayingCard;//Java groups things in packages - package name must match folder name for the package
